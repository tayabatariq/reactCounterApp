...
function Feauture() {
  return (
    <>
    <div id='feature' className='w-full gap-3 h-full bg-zinc-200 flex flex-col items-center justify-center px-32 max-sm:px-2 max-sm:py-2 py-12'>
      <h1 className='text-6xl uppercase font-bold max-sm:text-4xl max-md:text-5xl '>Explore Advanced Features</h1>
      <div className='w-full h-96 flex items-center gap-8 mt-10 justify-center max-sm:flex-col max-md:flex-col '>
    ...
    <Div link="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Y29tcHV0ZXIlMjBpbWFnZXxlbnwwfHwwfHx8MA%3D%3D" heading=" Download Results " para="After converting your text, download the result as a file in TXT, PDF, or DOC format. Simplify your workflow with ease!"/>
